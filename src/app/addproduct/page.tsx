...
const AddProductPage = () => {
    ...
    return (
        <div className="p-5 max-w-7xl mx-auto">
         <h1 className="text-2xl font-bold">Add PDF</h1>
   ...
   <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-purple-500 shadow-lg bg-slate-800">
                                   {preview ? (
...
<input id="image" name="image" type="file" accept="image/*" className="hidden" onChange={handleImageChange} />
                ...
                >
                  ...
                  <Select.Popover>
                    <ListBox>
                      ...
                      <ListBox.Item id="Novel" textValue="Novel">
                        Novel
                        <ListBox.ItemIndicator />
                      </ListBox.Item>
                      ...
                      <ListBox.Item id="Comics" textValue="Comics">
                        Comics
                        <ListBox.ItemIndicator />
                      </ListBox.Item>
            ...
            <Button
              type="submit"
              variant="outline"
              className=" rounded-2xl w-full bg-purple-500 text-white"
            >
             Add PDF
            </Button>
          </form>
